---
title: "Using the excessmort package to generate an excess mortality plot for USA 2017-2023"
...
This file contains two parts. First the data wrangling part, which is somewhat complex. Then we use compute expected death counts and plot along with observed counts. This is relatively simple with the `excessmort` package.
...
Next we get population estimates from the Census. You will need a census API key which you can get 
