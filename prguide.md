...
This website lets you search for recommendations by topic:
...
| Isla Verde | Carolina / San Juan | Medium | Near SJU Airport | **Beach** Long sandy beach by hotels; windsurfing & jogging. |
| Pine Grove | Isla Verde | Medium | Near SJU Airport | **Beach** Best surf beach in metro area; lessons available. |
| Plaza del Mercado (La Placita) | San Juan | Hard | Calle Canals | **Nightlife** Free live music Thu–Fri; extremely busy. |
...
| Place | Area | Difficulty | Address | Description |
|---------------|---------------|---------------|---------------|---------------|
| Cavernas de Camuy | North | Medium |  | **Caves (Favorite)** Massive underground cave/river system. |
...
| Place | Area | Difficulty | Address | Description |
|---------------|---------------|---------------|---------------|---------------|
| Crash Boat Beach | NorthWest (Aguadilla) | Medium |  | **Beach (Favorite)** Crystal water, pier jumping, snorkeling. |
